...
class WeeklyAssessment(db.Model):
    ...
    # ── Field identification (supports multiple fields of same crop) ──
    field_name = db.Column(db.String(100), default='Field 1')       # e.g. "North Field", "Field 2"
    field_location = db.Column(db.String(200))                       # optional GPS or text
    session_id = db.Column(db.String(64))                            # UUID per session/field, set at Week 1
